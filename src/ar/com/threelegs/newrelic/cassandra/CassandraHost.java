 ...
 * @author juanformoso
 */
public class CassandraHost extends Agent {

	private String name = "Default";
	private String host;
	private Config config;

	public CassandraHost(String host, Config config) throws UnknownHostException {
		super("ar.com.3legs.newrelic.cassandra.host", "0.0.2");
